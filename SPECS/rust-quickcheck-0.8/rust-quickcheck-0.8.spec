...
%global pkgname quickcheck-0.8

Name:           rust-quickcheck-0.8
Version:        0.8.0
Release:        %autorelease
Summary:        Rust crate "quickcheck"
License:        Unlicense OR MIT
URL:            https://github.com/BurntSushi/quickcheck
#!RemoteAsset:  sha256:dd69f633f796e091acd9a53e093bf01745b2c10ba44d22ea788f5fcbb862b720
...
Requires:       crate(rand-0.6/default) >= 0.6.3
Requires:       crate(rand-core-0.3/default) >= 0.3.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(env-logger-0.5) >= 0.5.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(env-logger-0.5/regex) >= 0.5.0
