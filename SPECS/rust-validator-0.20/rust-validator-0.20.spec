...
%global pkgname validator-0.20

Name:           rust-validator-0.20
Version:        0.20.0
Release:        %autorelease
Summary:        Rust crate "validator"
License:        MIT
URL:            https://github.com/Keats/validator
#!RemoteAsset:  sha256:43fb22e1a008ece370ce08a3e9e4447a910e92621bb49b85d6e48a45397e7cfa
...
Requires:       crate(idna-1/default) >= 1.1.0
...
Requires:       crate(validator-derive-0.20/nightly-features) >= 0.20.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(validator-derive-0.20/default) >= 0.20.0
