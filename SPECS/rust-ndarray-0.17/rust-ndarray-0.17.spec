...
%global pkgname ndarray-0.17

Name:           rust-ndarray-0.17
Version:        0.17.2
Release:        %autorelease
Summary:        Rust crate "ndarray"
License:        MIT OR Apache-2.0
URL:            https://github.com/rust-ndarray/ndarray
#!RemoteAsset:  sha256:520080814a7a6b4a6e9070823bb24b4531daac8c4627e08ba5de8c5ef2f2752d
...
Requires:       crate(matrixmultiply-0.3/cgemm) >= 0.3.10
...
Requires:       crate(portable-atomic-util-0.2/default) >= 0.2.6
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(matrixmultiply-0.3/cgemm) >= 0.3.10
Requires:       crate(matrixmultiply-0.3/threading) >= 0.3.10
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(portable-atomic-1/critical-section) >= 1.13.1
...
Summary:        N-dimensional array for general elements and for numerics - feature "serde"
Requires:       crate(%{pkgname}) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(matrixmultiply-0.3/cgemm) >= 0.3.10
Requires:       crate(matrixmultiply-0.3/std) >= 0.3.10
