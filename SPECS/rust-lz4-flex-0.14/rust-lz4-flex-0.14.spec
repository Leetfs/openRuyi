...
%global pkgname lz4-flex-0.14

Name:           rust-lz4-flex-0.14
Version:        0.14.0
Release:        %autorelease
Summary:        Rust crate "lz4_flex"
License:        MIT
URL:            https://github.com/pseitz/lz4_flex
#!RemoteAsset:  sha256:ecbdfe44b1bd960b68170b417450a628c43f7cf56bb3c5317e61cb230ee7f226
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(%{pkgname}/std) = %{version}
Requires:       crate(twox-hash-2/xxhash32) >= 2.1.3
