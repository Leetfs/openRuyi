...
#!RemoteAsset:  sha256:a5e00b96a521718e08e03b1a622f01c8a8deb50719335de3f60b3b3950f069d8
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3) >= 0.21.2
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3-py310) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3-py310) >= 0.21.2
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3-py311) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3-py311) >= 0.21.2
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3-py312) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3-py312) >= 0.21.2
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3-py37) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3-py37) >= 0.21.2
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3-py38) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3-py38) >= 0.21.2
...
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/abi3-py39) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
Requires:       crate(pyo3-ffi-0.21/abi3-py39) >= 0.21.2
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(chrono-tz-0.6) >= 0.6.0
...
Requires:       crate(pyo3-macros-0.21/experimental-async) >= 0.21.2
...
%package     -n %{name}+experimental-declarative-modules
Summary:        Bindings to Python interpreter - feature "experimental-declarative-modules"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(%{pkgname}/macros) = %{version}
Requires:       crate(pyo3-macros-0.21/experimental-declarative-modules) >= 0.21.2
Provides:       crate(%{pkgname}/experimental-declarative-modules) = %{version}

%description -n %{name}+experimental-declarative-modules
This metapackage enables feature "experimental-declarative-modules" for the Rust pyo3 crate, by pulling in any additional dependencies needed by that feature.

%package     -n %{name}+extension-module
Summary:        Bindings to Python interpreter - feature "extension-module"
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-ffi-0.21/extension-module) >= 0.21.2
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(eyre-0.4/default) >= 0.4.0
...
Requires:       crate(%{pkgname}/experimental-declarative-modules) = %{version}
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-ffi-0.21/generate-import-lib) >= 0.21.2
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(hashbrown-0.9/default) >= 0.9.0
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(indexmap-1/default) >= 1.6.0
...
Requires:       crate(pyo3-macros-0.21/multiple-pymethods) >= 0.21.2
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-macros-0.21/default) >= 0.21.2
