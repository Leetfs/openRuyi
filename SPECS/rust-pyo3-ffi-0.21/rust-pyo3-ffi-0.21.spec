...
%global pkgname pyo3-ffi-0.21

Name:           rust-pyo3-ffi-0.21
Version:        0.21.2
Release:        %autorelease
Summary:        Rust crate "pyo3-ffi"
License:        MIT OR Apache-2.0
URL:            https://github.com/pyo3/pyo3
#!RemoteAsset:  sha256:01be5843dc60b916ab4dad1dca6d20b9b4e6ddc8e15f50c47fe6d85f1fb97403
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/extension-module) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
...
Requires:       crate(%{pkgname}) = %{version}
Requires:       crate(pyo3-build-config-0.21) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/python3-dll-a) >= 0.21.2
Requires:       crate(pyo3-build-config-0.21/resolve-config) >= 0.21.2
